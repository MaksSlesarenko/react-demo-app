...
This app utilizes the open hacker news API provided by Ycombinator to display ten stories at random order from the top stories list and presents these stories on a web page sorted by story score ascendingly.
